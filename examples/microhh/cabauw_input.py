...
timedep_surface = {"time_surface": les_input["time_sec"], "p_sbot": les_input["ps"]}
...
mlt.write_netcdf_input("cabauw", "f8", init_profiles, timedep_surface, timedep_ls, radiation, soil)
